...
<p>We ❤️ Dogs is a single page social media web app for viewing, liking, and rating cute dog content pulled from curated twitter API endpoints. </p>
<hr></hr>
<p>
  See the Back-End <a href="https://github.com/noamsauerutley/dog-rating-app-api">here</a>.
</p>
<hr></hr>
...
<h1><a href="https://dog-rating-app-frontend.now.sh/">Check it out on Now </a></h1>
 ...
 <hr></hr>
  <div>
  <p>View demo as <a href="https://i.imgur.com/C7R3OHw.gif">GIF on Imgur</a> or <a href="https://youtu.be/2DERutbways">video on Youtube</a></p>
</div>  

<div display="flex" flex-direction="row" flex-wrap="wrap" text-align="center" justify-content="space-around">
    <img src="https://i.imgur.com/mNdFEhI.png" alt="We Heart Dogs home page"/>
    <img src="https://i.imgur.com/0YRCqYq.png" alt="We Heart Dogs detail page"/>
</div>
<hr>
</hr>
...
<ul>
<li> Clone this repo to your local machine using <code>https://github.com/noamsauerutley/dog-rating-app-frontend.git</code></li>
</ul>
</li>
</ul>
...
<ul>
<li> Create a new pull request using <a href="https://github.com/noamsauerutley/dog-rating-app-frontend/compare/"><code>https://github.com/noamsauerutley/dog-rating-frontend/compare/</code></a>.</li>
</ul>

<hr></hr>
Built alongside <a href="https://github.com/EthanJF">Ethan Fournier</a>
<hr></hr>
